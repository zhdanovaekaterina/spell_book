...
def params_for_detail_raw():
    return [
        (
            ...
            {
                'description': 'Описание заговора. В нескольких абзацах. Урон этого заклинания увеличивается на 1к6, когда вы достигаете 5-го уровня (2к6), 11-го уровня (3к6) и 17-го уровня (4к6). ',
